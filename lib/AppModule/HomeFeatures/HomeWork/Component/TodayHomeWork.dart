...
class TodayHomeWork extends StatelessWidget {
  TodayHomeWork({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      return workController.isLoading.value
          ...
          : workController.todayWorkList.isNotEmpty
              ? ListView.builder(
                  physics: BouncingScrollPhysics(),
                  padding: EdgeInsets.zero,
                  shrinkWrap: true,
                  primary: false,
                  itemCount: workController.todayWorkList.length,
                                        ...
                                        children: [
                                          Padding(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                Text(
                                                  workController.todayWorkList[index]
                                                      .subject.name ??
                                                      "subject",
                                                  style: TextStyle(
                                                    fontSize: 16,
                                                ...
                                                AppText(
                                                  title: DateFormat('dd MMM yyyy').format(
                                                    workController.todayWorkList[index].date,
                                                  ),
